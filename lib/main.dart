import 'package:comics_test/controllers/get_controller.dart';
import 'package:comics_test/pages/comic_detail_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Comic Book Application'),
    );
  }
}
      ...
      children: [
        GestureDetector(
          child: Container(
            ...
            color: listView ? Colors.transparent : Colors.blue,
            child: Padding(
        ...
        GestureDetector(
          child: Container(
            ...
            color: listView ? Colors.blue : Colors.transparent,
            child: Padding(
